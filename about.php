  ...
  <body>
    ...
    <section class="showtime_page">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p style="font-size: 3vw; font-weight: bold;text-align: center;">Movie Ticket is build For CLOUD COMPUTING project.
            </p>
           <P>CREATED BY : SHIVAM KASHYAP (19MCA1029)</P>
		   <P>           : PRAKASH SHEKHAR (19MCA1062)</P>
          </div>
        </div>
      </div>
    </section>
